...
mod zkvm {
    ...
    /// AffinePoint
    pub type AffinePoint = pico_patch_libs::ecdsa::AffinePoint<Secp256k1>;
    /// ProjectivePoint
    pub type ProjectivePoint = pico_patch_libs::ecdsa::ProjectivePoint<Secp256k1>;
    /// Scalar
    pub type Scalar = scalar::Scalar;

    impl pico_patch_libs::ecdsa::ECDSACurve for Secp256k1 {
        type FieldElement = FieldElement;
        type PicoAffinePoint = pico_patch_libs::secp256k1::Secp256k1Point;
    ...
    impl pico_patch_libs::ecdsa::Field<Secp256k1> for FieldElement {
